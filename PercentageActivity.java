 ...
 */
public class PercentageActivity extends View {
    ...
    //当前进度
    private int mProgress = 70;
    //外层弧线的宽
    private int mCircleLineStrokeWidth;

    public PercentageActivity(Context context) {
        this(context,null);
    }

    public PercentageActivity(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public PercentageActivity(Context context, AttributeSet attrs, int defStyleAttr) {
