 ...
 */
public class WaiKePercentageActivity extends View {
    ...
    public WaiKePercentageActivity(Context context) {
        this(context,null);
    }

    public WaiKePercentageActivity(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public WaiKePercentageActivity(Context context, AttributeSet attrs, int defStyleAttr) {
