 ...
 */
public class NeiKePercentageActivity extends View {
    ...
    public NeiKePercentageActivity(Context context) {
        this(context,null);
    }

    public NeiKePercentageActivity(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public NeiKePercentageActivity(Context context, AttributeSet attrs, int defStyleAttr) {
