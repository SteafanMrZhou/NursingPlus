 ...
 */
public class FuKEPercentageActivity extends View {
    ...
    public FuKEPercentageActivity(Context context) {
        this(context,null);
    }

    public FuKEPercentageActivity(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public FuKEPercentageActivity(Context context, AttributeSet attrs, int defStyleAttr) {
